...
import by.itacademy.dzhivushko.cars.dao.orm.impl.entity.Brand_;
import by.itacademy.dzhivushko.cars.dao.orm.impl.entity.Model;
...
public class ModelDaoImpl extends AbstractDaoImpl<IModel, Integer> implements IModelDao {
	...
	public IModel getFullInfo(final Integer id) {
		...
		from.fetch(Model_.modelInfo, JoinType.LEFT);
		from.fetch(Model_.brand, JoinType.LEFT);

		from.fetch(Model_.engines, JoinType.LEFT);
