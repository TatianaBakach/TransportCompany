...
<div class="row">
    ...
    <form:form class="col s12" method="POST" action="${pagesLocality}"
        ...
        <div class="row">
         ...
         <div class="row">
            <div class="input-field col s6">
                ...
                <label for="regionId"><spring:message code="locality.column.region" /></label>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col s3">
                <a class="btn waves-effect waves-light right red darken-2" href="${pagesLocality}"><spring:message code="page.button.cancel" /></a>
            </div>
        </div>
    </form:form>
</div>
