...
<div class="row">
	...
	<form:form class="col s12" method="POST" action="${pagesCompany}"
		...
		<div class="row">
			...
			<div class="input-field col s4">
				<form:input path="payerRegistrationNumber" type="text"
					disabled="${readonly}" />
				<form:errors path="payerRegistrationNumber" cssClass="red-text" />
				<label for="payerRegistrationNumber">Company payer
			...
			<div class="row">
				<div class="input-field col s12">
					<form:textarea path="bankData" disabled="${readonly}"
			...
			<div class="row">
				<div class="input-field  col s12">
					<form:select path="employeeIds" disabled="${readonly}"
						multiple="true">
						<option value="" disabled ${emptyformModel.employeeIds? "selected":""}>выберите
							сотрудников</option>
						<form:options items="${employeesChoices}" />
					</form:select>
