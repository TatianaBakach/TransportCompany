...
<h4 class="header">AJAX location</h4>


<div style="margin: 10px;">
    <form:form class="col s12" method="POST" action="${pageContext.request.contextPath}/ajax-samples" modelAttribute="addressForm">
        <div class="row">
            <div class="col s12">
        ...
        <button onclick="submitForm()"  type="button" >submit via ajax</button>
    </form:form>
</div>
