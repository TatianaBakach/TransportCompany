package by.itacademy.tatabakach.transportcompany.web.tag;
...
import by.itacademy.tatabakach.transportcompany.web.dto.grid.SortDTO;

public class SortLink extends SimpleTagSupport {

	private String column; // id

	private String pageUrl; // /cargotrans/car/
